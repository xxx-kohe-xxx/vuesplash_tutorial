...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // pathとコンポーネントのマッピング
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  mode: 'history',
  // /#/という表示にならないようにする
  routes: routes // マッピングしたroutesを入れる
...
var state = {
  ...
  // バリデーションエラーのときのエラーメッセージ (ログインフォーム)
...
var mutations = {
  ...
  setLoginErrorMessage: function setLoginErrorMessage(state, messages) {
    state.loginErrorMessage = messages;
  },
  setRegisterErrorMessage: function setRegisterErrorMessage(state, messages) {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              if (response.status === _util__WEBPACK_IMPORTED_MODULE_1__["UNPROCESSABLE_ENTITY"]) {
                ...
                comtext.commit('error/setCode', response.status, {
                  root: true
                });
              }
...
__webpack_require__(/*! /Users/suzukikouhei/code/vuesplash/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/suzukikouhei/code/vuesplash/resources/sass/app.scss */"./resources/sass/app.scss");
